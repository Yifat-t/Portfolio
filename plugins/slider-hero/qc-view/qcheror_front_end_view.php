...
?>
	...
	?>
		...
		?>
		<div class="qcld_hero_content_area" <?php echo (isset($slide->image_link)&&$slide->image_link!=''?'data-bg-image="'.esc_url( $slide->image_link ).'"':'data-bg-image=""') ?> style="display:none;">
...
<div class="sh_vimeo_wrapper">
		...
		<iframe src="https://player.vimeo.com/video/<?php echo esc_url( $preimg[0] ); ?>?<?php echo (isset($params->videoslide_mute)&& $params->videoslide_mute=='1'?'background=1&':''); ?>autoplay=1<?php echo (isset($params->videoslide_loop)&& $params->videoslide_loop=='1'?'&loop=1':'&loop=0'); ?>&byline=0&title=0&quality=1080p" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
